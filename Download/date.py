...
#-----------------------------------------------is here--------------------------------------------------------------
    ...
    def contin():
        ...
        if w1 == "" or w2 == ""or w3 == "" or w4 == "" or w5 == "":
            ...
            label9 = Label(teach, text = "Please enter the given number: {}".format(result),bg = "#326273",font = ("Times New Roman",14))
            label9.grid( row = 0, column = 0, padx = 10, pady = 10)

            label10 = Label(teach, text = "Confirm Number:",bg = "#326273",font = ("Times New Roman",14))
            label10.grid(row = 1, column = 0)

            enter = Entry(teach, bd = 4, width = 15)
            enter.grid(row = 2, column = 0, padx = 10, pady = 10)
            
            ran = Button(root33, text = "Generate",width = 15,bg = "pink",command = go)
