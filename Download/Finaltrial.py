...
#---------------------------------------------Buttons-----------------------------------------------------------------
    btn = Button(root0,text = "INSERT",border = 2,width = 12, fg = "Black", command = lambda:InsertData(tree))
...
#---------------------------------------------Buttons-----------------------------------------------------------------
    ...
    Next = Button(root0,text = "Done", bd = 0, width = 10,bg = "white", fg ="Black",command = info)
    ...
    note = Label(lab, text = " a. Enter the exam-hall in numeric form only eg: 88 \n b. Provide the number of teacher invigilating \n c. To delete the row from a table insert the row id in the exam hall number textbox \n d. Enter the numbers of hall-number for exam depending on the teacher required. \n For example: The number of teacher invigilating is 2, then enter the same hall number twice",font=("Times New Roman",11),justify="left", bg = "white")
    note.grid(row = 0, column = 0)

    back = Button(root0, bd = 0, width = 10,bg = "#326273", text = "Home", fg = "White", command= root0.destroy).place(x = 0, y = 0)
    ...
    def edit():
        ...
        Delete = Button(root0,text = "delete",fg = "Black",bd = 0,width = 10,command = DeleteRow)
        Delete.place(x = 750, y = 408)

        del_db = Button(root0,text="New Page",bg = "white",command=deleteRoom)
        del_db.place(x=1000, y = 408)

    btn10 = Button(root0, bd = 0, width = 10, text = "Edit", fg = "Black", command = edit)
