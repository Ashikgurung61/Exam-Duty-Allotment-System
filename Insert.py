...
def show():
   ...
   #---------------------------Connection --------------------------------------------
    ...
    tree['columns'] = ("hNo","t_No","id")

    #assign the width, minwidth 
    #tree.column("hNo", width = 50, minwidth=50) 
   
    tree.column("hNo",width = 208, minwidth = 80,anchor='center')
    tree.column("t_No",width = 208, minwidth = 80,anchor='center')
    tree.column("id",width = 30, minwidth = 80,anchor='center')                  
